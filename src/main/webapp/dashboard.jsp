  ...
  <body class="bg-light">
        ...
        <div class="col-md-10 p-4">
          ...
          <div class="mt-5">
            ...
            <div class="d-flex gap-3">
              <a href="${pageContext.request.contextPath}/add-product.jsp" class="btn btn-primary">
                Add Product
              </a>
    ...
    <script>
      ...
      const salesChart = new Chart(ctx, {
        type: 'bar',
        data: {
          labels: [<c:out value="${salesLabels}" escapeXml="false" />],
          datasets: [{
            label: 'Revenue ($)',
            data: [<c:out value="${salesData}" escapeXml="false" />],
